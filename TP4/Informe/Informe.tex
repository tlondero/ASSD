...
\section{Aportes}
Se decidió implementar todo código en \textbf{Python}, apoyándose en la librería \href{https://opencv.org/}{OpenCV}.

Se desarrolló un programa capaz de realizar el seguimiento de una sección deseada en tiempo real. El software permite al usuario seleccionar un área rectangular de su cámara, siendo los elementos dentro de dicha sección los cuales son seguidos por el programa.
