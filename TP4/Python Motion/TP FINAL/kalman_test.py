...
def main():
    img_height = 500
    img_width = 500
    #dynamParams: Dimensionality of the state = 2.
    #measureParams: Dimensionality of the measurement = 1.
    #controlParams: Dimensionality of the control vector = 0.
    ...
    while True:
        ...
        while True:
            ...
            state_pt = calc_point(state_angle)          #REAL MODEL??

            prediction = kalman.predict()
            predict_angle = prediction[0, 0]
            predict_pt = calc_point(predict_angle)      #PREDICTION??
            ...
            measurement_pt = calc_point(measurement_angle) #MEASURED POSITION??
