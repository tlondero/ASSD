...
\textbf{3/2 Seno}   & 1                  & 23500                 & 50        &      0.268     \\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/LA - 3 2.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/LA - Cos.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/LA - Tri.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/SH - 3 2.png}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/SH - Cos.png}
\end{figure}
\begin{figure}[H]
\centering
	\includegraphics[width=0.5\textwidth]{ImagenesEjercicio6/SH - Tri.png}
\end{figure}
\end{multicols}
