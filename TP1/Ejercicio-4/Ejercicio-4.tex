...
Siguiendo las recomendaciones del fabricante, es deseable que el \textbf{hold step} se mantenga por debajo de la mitad del paso de tensión que representa al LSB. 
$$V_{hs}\lesssim\frac{FS}{2^(n+1)}$$
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{ImagenesEjercicio4/HoldStep}
	\caption{}
	\label{fig:holdstep}
\end{figure}
