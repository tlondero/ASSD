...
\begin{tikzpicture}[yscale=1]
	...
	%PULSO: AND (A, B)
	\draw[draw=red, thick] (0,0) \pulse{0.5*\xMaxp}{0.25}{\rowForPulse} \pulse{0.5*\xMaxp}{0.25}{\rowForPulse} ++ (1,0.5) node[label=right:{\textcolor{black}{$A\&B = f_{conv}$}}](){};
	
	%PULSO: C
	\draw[draw=magenta, thick] (0,\rowHeigth) \pulse{0.25*\xMaxp}{0.5}{\rowForPulse} \pulse{0.25*\xMaxp}{0.5}{\rowForPulse} \pulse{0.25*\xMaxp}{0.5}{\rowForPulse}  \pulse{0.25*\xMaxp}{0.5}{\rowForPulse} ++ (1,0.5) node[label=right:{\textcolor{black}{$\frac{f_{CLK}}{96} = C$}}](){};
	
	%PULSO: B
	\draw[draw=violet, thick] (0, 2*\rowHeigth) \pulse{0.5*\xMaxp}{0.5}{\rowForPulse} \pulse{0.5*\xMaxp}{0.5}{\rowForPulse} ++ (1,0.5) node[label=right:{\textcolor{black}{$\frac{f_{CLK}}{48} = B$}}](){};
