...
\begin{circuitikz}
	...
	\draw 
		...
		($ (ccc_thr.center) !.5! (ccc_tri.center) $) node[circ](){} -- ++ (-3,0) node[circ](aux1){} to[pR, name=pr, l_=$R_{POT}$] ++(0,2) to[R, l=$R_T$] ++(0,2) node[npn, anchor=E, label=left:$BC547$, xscale=-1](q){}
		(q.E) node[circ](){} to[D, l_=$BC547$] ++(2,0) node[circ](aux2){} |- (ccc_dis.center)
